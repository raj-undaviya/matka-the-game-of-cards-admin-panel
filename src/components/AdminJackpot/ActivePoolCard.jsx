  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-5 sm:p-6 xl:p-8 shadow-sm flex min-w-0 flex-col justify-between h-full overflow-hidden">
      ...
      <div>
        ...
        {/* Large Jackpot value */}
        <h2 className="max-w-full text-2xl sm:text-4xl 2xl:text-5xl font-black text-emerald-600 tracking-normal leading-tight mb-3 whitespace-nowrap">
          {poolAmount}
        </h2>
      ...
      <div className="border-t border-slate-100 pt-6 mt-auto">
        <div className="grid grid-cols-1 sm:grid-cols-[minmax(0,1fr)_minmax(5.5rem,8rem)] gap-5 sm:gap-4 items-end">
          {/* Sub-metrics stack */}
          <div className="grid min-w-0 grid-cols-1 min-[480px]:grid-cols-3 gap-4">
          ...
          <div className="flex min-w-0 items-end justify-between h-20 px-1 sm:px-2">
